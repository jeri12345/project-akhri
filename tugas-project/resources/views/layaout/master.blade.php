...
<link href="{{asset('template/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css')}}" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="{{asset('template/styles/teachers_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('template/styles/teachers_responsive.css')}}">
</head>
<body>
...
<script src="{{asset('template/plugins/scrollTo/jquery.scrollTo.min.js')}}"></script>
<script src="{{asset('template/plugins/easing/easing.js')}}"></script>
<script src="{{asset('template/js/teachers_custom.js')}}"></script>
